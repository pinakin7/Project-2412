...
class Generator(nn.Module):
    def __init__(self, noise_dims: int, num_filters: int, num_channels: int, num_gpus: int, num_disc_filters:int):
...
if __name__ == "__main__":
    ...
    net = Generator(utils.dpgan_noise_dim, utils.num_dpgan_generator_filter, utils.num_channels,
                    utils.num_gpus, utils.num_dpgan_discriminator_filter).to(utils.device)
